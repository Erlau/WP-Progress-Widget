<?php
/**
* Plugin Name: WP progress bars widget
* Plugin URI: http://wle.dk/
* Description: Show skills (or anything else you want) as progress bars
* Version: 0.1
* Author: Erik Weber-Lauridsen
* Author URI: http://www.wle.dk
*/

// ADD FUNTION TO WIDGETS_INIT
add_action( 'widgets_init', 'reg_wpprogress' );

// REGISTER WIDGET
function reg_wpprogress() {
	register_widget( 'wpprogress_Widget' );
}

// WIDGET CLASS
class wpprogress_Widget extends WP_Widget {
...
public function __construct() {
	parent::__construct(
 		'wpprogress', // BASE ID
		'Progress / Skills Widget', // NAME
		array( 'description' => __( 'A custom widget that displays up to 5 skill sets' ), )
	);
}
...
function widget( $args, $instance ) {
	...
	<div class="progress-parts">
		...
		</ul><!-- END .progress-partset -->

    </div><!-- END .progress-parts -->
...
function form( $instance ) {
	...
	<table>
		<tr>
	    	<td width="50%">		
				<label for="<?php echo $this->get_field_id( 'skill1' ); ?>"><?php _e('Skill Title:' ) ?></label>
			...
			<td width="30%">	
				<label for="<?php echo $this->get_field_id( 'color1' ); ?>"><?php _e('Hex:' ) ?></label>
			...
			<td width="20%">	
				<label for="<?php echo $this->get_field_id( 'percent1' ); ?>"><?php _e('Per:' ) ?></label>
	...
	<table>
		<tr>
	    	<td width="50%">		
				<label for="<?php echo $this->get_field_id( 'skill2' ); ?>"><?php _e('Skill Title:' ) ?></label>
			...
			<td width="30%">	
				<label for="<?php echo $this->get_field_id( 'color2' ); ?>"><?php _e('Hex:' ) ?></label>
			...
			<td width="20%">	
				<label for="<?php echo $this->get_field_id( 'percent2' ); ?>"><?php _e('Per:' ) ?></label>
	...
	<table>
		<tr>
	    	<td width="50%">		
				<label for="<?php echo $this->get_field_id( 'skill3' ); ?>"><?php _e('Skill Title:' ) ?></label>
			...
			<td width="30%">	
				<label for="<?php echo $this->get_field_id( 'color3' ); ?>"><?php _e('Hex:' ) ?></label>
			...
			<td width="20%">	
				<label for="<?php echo $this->get_field_id( 'percent3' ); ?>"><?php _e('Per:' ) ?></label>
	...
	<table>
		<tr>
	    	<td width="50%">		
				<label for="<?php echo $this->get_field_id( 'skill4' ); ?>"><?php _e('Skill Title:' ) ?></label>
			...
			<td width="30%">	
				<label for="<?php echo $this->get_field_id( 'color4' ); ?>"><?php _e('Hex:' ) ?></label>
			...
			<td width="20%">	
				<label for="<?php echo $this->get_field_id( 'percent4' ); ?>"><?php _e('Per:' ) ?></label>
	...
	<table>
		<tr>
	    	<td width="50%">		
				<label for="<?php echo $this->get_field_id( 'skill5' ); ?>"><?php _e('Skill Title:' ) ?></label>
			...
			<td width="30%">	
				<label for="<?php echo $this->get_field_id( 'color5' ); ?>"><?php _e('Hex:' ) ?></label>
			...
			<td width="20%">	
				<label for="<?php echo $this->get_field_id( 'percent5' ); ?>"><?php _e('Per:' ) ?></label>
